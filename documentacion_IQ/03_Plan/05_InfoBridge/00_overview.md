...
Access business data from multiple systems in a single platform, reducing the need to switch between tools.

**Data integration**
Combine and harmonize data from different types of sources to create unified reports.

**Collaborative planning**
Create forecasts, budgets, and plans across multiple planning sheets and integrate them with InfoBridge.

**Advanced data transformation**
Join, merge, append, group, and pivot rows and columns.

**Data cleansing functions**
Built-in data cleansing functions, such as rounding, text manipulation, find-and-replace, and sorting to help standardize, clean, and organize datasets.

## Next steps

Learn how to use InfoBridge in the following articles:

- Connect measures between Planning sheets

- Write back InfoBridge data
