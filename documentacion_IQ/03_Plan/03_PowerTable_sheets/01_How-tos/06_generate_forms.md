...
# Create data entry forms with PowerTable sheets
			...
			Feedback
				...
				In this article
					...
					_Forms_ allow you to collect data from users and write them directly to your database.
...
Select **Create a Form**. A form is generated with all the fields in the database.

Select **Save** to generate the form with the default configuration.
...
Select **Add Field** to add a new field from the table. Alternatively, select the **+** icon next to any field to add a new field.

Select the required fields from the list. Select **Select All** to select all the table fields to add to the form.
...
To group similar fields, use the **+** icon beside the field to group the new field with the existing one.
...
Select **Share** to create a shareable link for your form. You can share it to all users or restrict it to specific users by entering their email addresses.

Choose an expiration date for the form. Select **Generate Link**.
