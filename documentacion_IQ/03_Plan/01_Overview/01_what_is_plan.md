...
By planning directly in Microsoft Fabric, plan removes the need for separate planning tools or spreadsheetâbased workflows. Organizations can bring goals, plans, and actual results together on shared semantic models, making it easier to move from manual planning to continuous, dataâdriven decisions.

By combining historical data, real-time signals, and future projections in a single environment, plan creates an AIâready foundation for smarter decisions.

To learn which regions support plan during preview, see Region availability for plan (preview).

Note

The preview of plan in Fabric IQ is now accessible to organizations worldwide in Microsoft Fabric as part of the Microsoft Fabric SKU, and new meters have been created. Meters are currently available but are not currently billed. To learn about Planning sheet limitations, see Known limitations.
...
Planning sheets are used for budgeting, forecasting, and scenario modeling. They allow users to define assumptions, inputs, and calculated outcomes in a familiar, spreadsheetâlike experience.
...
Intelligence sheets provide analytical insights and automated variance analysis over planning data. They help users understand variances, trends, and forwardâlooking implications.
...
This setting is **required** to create plan (preview) items: _Users can create Plan (preview) items_.
