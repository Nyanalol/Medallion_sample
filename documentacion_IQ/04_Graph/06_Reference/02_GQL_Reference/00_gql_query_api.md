...
- You need to install and set up the Azure CLI tool az to sign in to your organization. Command line examples in this article assume use of a POSIX-compatible command line shell such as bash.
...
- --query '{query}' for listing only items that match the provided JMESPath {query}. See the Azure CLI documentation on JMESPath regarding the supported syntax for {query}.
...
code
string
six-character status code (000000 = success)
...
cause
object
Optional underlying cause status object
...
-2â¶Â³ to 2â¶Â³-1
Number or string*
{"gqlType": "INT64", "value": -9237}

UINT64
0 to 2â¶â´-1
Number or string*
{"gqlType": "UINT64", "value": 18467}
...
ZONED DATETIME
YYYY-MM-DDTHH:MM:SS[.ffffff]Â±HH:MM
{"gqlType": "ZONED DATETIME", "value": "2023-12-25T14:30:00+02:00"}
...
{"gqlType": "NODE", "value": "node-123"}

EDGE
Graph edge reference
{"gqlType": "EDGE", "value": "edge_abc#def"}
